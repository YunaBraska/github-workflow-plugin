...
import com.github.yunabraska.githubworkflow.git.WorkflowCurrentBranchResolver;
import com.github.yunabraska.githubworkflow.git.WorkflowRepository;
 ...
 */
public class WorkflowRunConfigurationProducer extends LazyRunConfigurationProducer<WorkflowRunConfiguration> {
    ...
    public static Optional<String> workflowPath(final Project project, final VirtualFile file) {
