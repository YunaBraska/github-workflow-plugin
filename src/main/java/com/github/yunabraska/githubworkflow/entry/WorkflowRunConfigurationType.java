 ...
 */
public class WorkflowRunConfigurationType implements ConfigurationType {
    ...
    private static class WorkflowRunConfigurationFactory extends ConfigurationFactory {
