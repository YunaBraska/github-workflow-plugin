 ...
 */
public class WorkflowRunLogRenderer {
    ...
    public static List<Segment> renderOnce(final String text) {
        return new WorkflowRunLogRenderer().render(text);
    }

    public static String renderPlainOnce(final String text) {
        return new WorkflowRunLogRenderer().renderPlain(text);
    }

    public List<Segment> render(final String text) {
    ...
    public String renderPlain(final String text) {
