...
import static com.github.yunabraska.githubworkflow.services.WorkflowContextCatalog.FIELD_RESULT;
import static com.github.yunabraska.githubworkflow.services.WorkflowAnnotations.addAnnotation;
...
import static com.github.yunabraska.githubworkflow.services.Jobs.listJobOutputs;
...
public class Needs {
    ...
    public static Optional<YAMLKeyValue> getJobNeed(final PsiElement psiElement) {
        return ofNullable(psiElement)
                .flatMap(WorkflowPsi::getParentJob)
