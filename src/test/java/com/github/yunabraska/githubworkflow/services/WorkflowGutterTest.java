...
public class WorkflowGutterTest extends EditorFeatureTestCase {
    ...
    public void testWorkflowDispatchShowsRunLineMarker() throws Exception {
        ...
        try {
            ...
            final RunLineMarkerContributor.Info info = new WorkflowRun.LineMarkerContributor().getInfo(dispatch.getKey());
    ...
    public void testWorkflowDispatchLineMarkerSwitchesToStopWhenRunIsTracked() {
                ...
                jobs:
                  build:
                    ...
                    steps:
                      - run: echo ok
                """);
        final String workflowPath = WorkflowRunConfiguration.Producer.workflowPath(getProject(), myFixture.getFile().getVirtualFile())
                .orElseThrow();
        ...
        try {
            ...
            WorkflowRun.Tracker.getInstance(getProject()).unregister(workflowPath, processHandler);
        }
    }
